...
const Creator = (props) => {
    ...
    const {
        ...
        selectedIndex, onChangeSelectedIndex, onSyncLrcLRC, onOutput, onDeleteTimestamp, onClearAlleTimestamp
    }= props;
    ...
    return (
        <Shortcuts id="app-creator" className="app-creator"
            ...
            <div className="tool-bar">
                <button className="tool-bar-button outputButton" onClick={() => onOutput()}>导出/编辑 LRC</button>
