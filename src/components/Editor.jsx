            ...
            <div className="editor">
                ...
                <section className="lrc-info-section">
                    <section className="lrc-info-input-section">
                        ...
                        <input placeholder="ti" name="ti" onBlur={this.updateInfo} value={lrc.info.get("ti")} />
                    </section>
                    <section className="lrc-info-input-section">
                        <span>{pref.i18n["lrc"]["artist"]}</span>
                        <input placeholder="ar" name="ar" onBlur={this.updateInfo} value={lrc.info.get("ar")} />
                    </section>
                    <section className="lrc-info-input-section">
                        <span>{pref.i18n["lrc"]["album"]}</span>
                        <input placeholder="al" name="al" onBlur={this.updateInfo} value={lrc.info.get("al")} />
                    </section>
                </section>
                <section className="lrc-textarea-section">
                    <textarea
